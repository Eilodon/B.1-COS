...
use crate::gnn::types::{GnnConfig, CausalEdgeKind, CausalEdge};
use crate::model::{InterdependentCausalModel, CausalHypothesis, CausalEdgeType};
use pandora_core::ontology::{EpistemologicalFlow, DataEidos};
use std::sync::Arc;
use fnv::FnvHashSet;
...
mod gnn_pipeline_tests {
    ...
    fn test_message_passing_rounds() {
        ...
        for _ in 0..3 {
            current_embedding = cwm.perform_message_passing_round(&current_embedding).unwrap();
        }
