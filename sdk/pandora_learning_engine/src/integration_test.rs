...
#[cfg(test)]
use crate::{Action, NeuralQValueEstimator, Policy, QValueEstimator, ValueDrivenPolicy};
#[cfg(test)]
use bytes::Bytes;
#[cfg(test)]
...
fn test_action_string_conversion() {
    ...
    assert_eq!(Action::Explore.as_str(), "explore");
    assert_eq!(Action::Exploit.as_str(), "exploit");
